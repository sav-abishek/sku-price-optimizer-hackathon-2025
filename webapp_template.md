...
1. **Use this template:** - Click "Use this template" button to create your team's repository and provide a suitable name and description.
...
3. **Build your web application:** in your cloned repository
    - Preferred techstack as below: 
        ...
        - Node.js + React
5. **Asimov user guide:** LTE teams refer the `notebooks/asimov_user_guide.ipynb` on Asimov API usage
...
## Asimov Models
- Only available for LTE teams 
- Reach out to anija.jacob@ab-inbev.com for getting the keys.
- Once key is received, rename the `.env.example` file in the root directory of your project and add the following lines
```
ASIMOV_API_KEY=your_asimov_api_key_here
```
- Refer the [Asimov model usage](./notebooks/asimov_user_guide.ipynb) for more code sample.
